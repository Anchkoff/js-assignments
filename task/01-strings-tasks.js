...
function encodeToRot13(str) {
    ...
    for (var i = 0; i < str.length; i++)
    {
        ...
        if (currChar < 65 || currChar > 123)
            result += String.fromCharCode(currChar);
        else if (currChar <= 77 || (currChar >= 97 && currChar < 110))
            result += String.fromCharCode(currChar + 13);
        else
            result += String.fromCharCode(currChar - 13);
    }
    return result;
